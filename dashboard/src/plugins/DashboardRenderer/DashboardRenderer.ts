import BoxRendererType, {
  ...
  import {
    DashboardLayoutSession,
    DashboardLayoutSessionProps,
  } from './DashboardLayoutSession'
...
export default class DashboardRenderer extends BoxRendererType {
    supportsSVG = true
    async fetchSequence(renderProps: RenderArgsDeserialized) {
      ...
      createSession(args: DashboardLayoutSessionProps) {
        return new DashboardLayoutSession(args)
      }
    }
